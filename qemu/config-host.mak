...
libs_softmmu=-lpixman-1 -lutil  -luuid -lpng16 -lz -lSDL -lX11  
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.3.0
PKGVERSION=
SRC_PATH=/home/sgt/6.828/lab/qemu
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/sgt/6.828/lab/qemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
