...
.LM30:
	leaq	.LC4(%rip), %rdi
	.stabn	68,0,69,.LM31-.LFBB3
.LM31:
	movq	%rax, 16(%rsp)
	.stabn	68,0,70,.LM32-.LFBB3
.LM32:
	xorl	%eax, %eax
	.stabn	68,0,69,.LM33-.LFBB3
.LM33:
	movl	$48, 4(%rsp)
...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L17:
	.stabn	68,0,84,.LM38-.LFBB4
.LM38:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,87,.LM39-.LFBB4
.LM39:
	leaq	224(%rsp), %rax
	.stabn	68,0,88,.LM40-.LFBB4
.LM40:
	movq	%r10, %rsi
	movl	%r11d, %edx
	.stabn	68,0,87,.LM41-.LFBB4
.LM41:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
